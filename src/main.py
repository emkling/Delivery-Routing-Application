    ...
    while user_choice != 'exit':
        ...
        if user_choice == '1':
            try:
                ...
                print("Total Mileage: " + str(package_delivery.calculate_total_distance()))
                print("All packages delivered by: " + str(package_delivery.find_final_delivery()))
                package_delivery.view_deliveries(4)
            ...
            try:
                ...
                if time_choice == 'b':
                    ...
                    time_simulator.output_all_package_statuses(time_choice)
            except ValueError:
                print("Please try another entry")
            ...
            try:
                ...
                if package_id == 'b':
                    ...
                    if time_choice == 'b':
                        ...
                        time_simulator.output_individual_package_status(package_id, time_choice)
            except ValueError:
